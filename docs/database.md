...
DB 名: `hjkland`(2026-07-28 に旧名 `vim-dojo` から変更。オーナー了承のもと旧 DB は引き継がず、初回起動時に削除する)。ストアは3つ。
...
```json
{ "app": "hjkland", "schemaVersion": 1, "exportedAt": "...", "profile": {...}, "attempts": [...], "dailyChallenges": [...] }
```
